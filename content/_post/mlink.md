---
title: Hexo AnZhiYu主题友链页面自定义数据源功能实现
date: 2026-06-1 10:00:00
categories:   #分类
- 博客
- 技术分享
tags: 
...
description: 详解如何在AnZhiYu主题中实现友链页面的自定义数据源功能，让一个模板支持多种页面类型
cover: /img/article/mlink_compressed.jpg
---
...
在 `source/_data/` 目录下创建对应的 `.yml` 文件：
